...
void lock_button_clicked(GtkWidget *widget, gpointer data)
{
    gtk_main_quit();
...
int main(int argc, char *argv[])
{
    ...
    GtkWidget *lock_image = gtk_image_new_from_file("./images/lock.png");
    ...
    gtk_button_set_image(GTK_BUTTON(lock_button), lock_image);
    ...
    g_signal_connect(lock_button, "clicked", G_CALLBACK(lock_button_clicked), NULL);
